...
System.register("app/scripts/components/dropdown.js", ["npm:babel-runtime@5.8.34/helpers/get", "npm:babel-runtime@5.8.34/helpers/inherits", "npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check", "npm:babel-runtime@5.8.34/core-js/object/keys", "npm:react@0.14.3"], function (_export) {
  var _get, _inherits, _createClass, _classCallCheck, _Object$keys, React, Dropdown;
      ...
      Dropdown = (function (_React$Component) {
        ...
        _createClass(Dropdown, [{
          ...
          value: function render() {
            ...
            var view = this.state.isOpen ? _Object$keys(this.props.user).map(function (userProp, index) {
              return React.createElement(
                "div",
                { key: index, className: "col-12 middle dropdown-details space-between" },
                React.createElement(
                  "label",
                  { className: "col-4 middle" },
                  userProp,
                  ":"
                ),
                " ",
                React.createElement(
                  "span",
                  { className: "col-6 middle" },
                  _this.props.user[userProp]
                )
              );
            }) : null;
            ...
            return React.createElement(
              "div",
              { className: "col-12 dropdown" },
              React.createElement(
                "button",
                { className: "btn btn-primary btn-block dropdown-toggle", onClick: this.click.bind(this) },
                this.state.isOpen ? "Hide Details" : "Show Details"
              ),
              React.createElement(
                "div",
                { className: "col-12 dropdown-content" },
                view
              )
            );
          }
...
System.register("app/scripts/components/user.js", ["npm:babel-runtime@5.8.34/helpers/get", "npm:babel-runtime@5.8.34/helpers/inherits", "npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check", "npm:babel-runtime@5.8.34/core-js/object/keys", "npm:react@0.14.3", "app/scripts/components/dropdown.js", "app/scripts/flux/Subscriber.js"], function (_export) {
  var _get, _inherits, _createClass, _classCallCheck, _Object$keys, React, Dropdown, Subscriber, User;
  ...
  return {
    setters: [function (_npmBabelRuntime5834HelpersGet) {
      ...
      React = _npmReact0143["default"];
    }, function (_appScriptsComponentsDropdownJs) {
      Dropdown = _appScriptsComponentsDropdownJs["default"];
    }, function (_appScriptsFluxSubscriberJs) {
      Subscriber = _appScriptsFluxSubscriberJs["default"];
    }],
    execute: function () {
      "use strict";

      User = (function (_React$Component) {
        ...
        _createClass(User, [{
          ...
          value: function doubleClick() {
            if (this.state.inEditMode) {
              ...
              Array.prototype.slice.call(formInputs, 0).forEach(function (input) {
          ...
          value: function _render() {
            ...
            if (this.state.inEditMode) {
              var inputsAsNodes = _Object$keys(this.props.userData).map(function (userDataProp) {
                return React.createElement(
                  "div",
                  { className: "col-12" },
                  React.createElement(
                  ...
                  " ",
                  React.createElement("input", { type: "text", name: userDataProp, defaultValue: _this.props.userData[userDataProp] })
                );
              });

              return React.createElement(
                "div",
                { id: "userEditForm", className: "col-12" },
                inputsAsNodes
              );
            } else {
              return React.createElement(
                "div",
                { className: "col-12 user" },
                React.createElement(
                  "h4",
                  { className: "col-12 center middle space-between title" },
                  React.createElement(
                    "span",
                    { className: "flex title-message" },
                    "Hi There, I am ",
                    this.props.userData.firstname
                  ),
                  React.createElement(
                    "button",
                    { className: "btn-sm btn-danger title-close-button", onClick: this.whenDeleted.bind(this) },
                    "X"
                  )
                ),
                React.createElement(
                  ...
                  React.createElement(
                    "span",
                    { className: "col-12 body-message" },
                    "I am from ",
                    this.props.userData.country,
                    " ",
                    this.props.userData.country === "Turkey" ? React.createElement(
                      "strong",
                      null,
                      "(Cool Mate!)"
                    ) : null
                ...
                React.createElement(Dropdown, { key: this.props.order, user: this.props.userData })
              );
            }
          }
        }, {
          ...
          value: function render() {
            ...
            return React.createElement(
              "div",
              { className: "col-12", onDoubleClick: this.doubleClick.bind(this) },
              view
            );
          }
        }]);
...
System.register("app/scripts/components/userList.js", ["npm:babel-runtime@5.8.34/helpers/get", "npm:babel-runtime@5.8.34/helpers/inherits", "npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check", "npm:react@0.14.3", "app/scripts/components/user.js", "app/scripts/flux/Subscriber.js"], function (_export) {
  var _get, _inherits, _createClass, _classCallCheck, React, User, Subscriber, timeout, UserList;
  ...
  return {
    setters: [function (_npmBabelRuntime5834HelpersGet) {
      ...
      React = _npmReact0143["default"];
    }, function (_appScriptsComponentsUserJs) {
      User = _appScriptsComponentsUserJs["default"];
    }, function (_appScriptsFluxSubscriberJs) {
      Subscriber = _appScriptsFluxSubscriberJs["default"];
    }],
    execute: function () {
        ...
        _createClass(UserList, [{
          ...
          value: function searchUser(e) {
            ...
            timeout = setTimeout(function () {
              console.log("Sending message to store ", _this.store);
              _this.store.publish("filter", e.target.value);
            }, 1000);
          }
        }, {
          key: "_render",
          value: function _render() {
            if (this.state.isAddingNewUser) {
              return React.createElement(
                "div",
                { id: "newUserForm", className: "form col-12" },
                React.createElement(
                  "div",
                  { className: "col-12 space-between" },
                  React.createElement(
                    "label",
                    { className: "col-3 middle" },
                    "First Name:"
                  ),
                  React.createElement("input", { className: "col-7 input-text", type: "text", name: "firstname" })
                ),
                React.createElement(
                  "div",
                  { className: "col-12 space-between" },
                  ...
                  React.createElement("input", { className: "col-7 input-text", type: "text", name: "surname" })
                ),
                React.createElement(
                  "div",
                  { className: "col-12 space-between" },
                  ...
                  React.createElement("input", { className: "col-7 input-text", type: "text", name: "country" })
                ),
                React.createElement(
                  "div",
                  { className: "col-12 space-between" },
                  ...
                  React.createElement("input", { className: "col-7 input-text", type: "text", name: "age" })
                ),
                React.createElement(
                  "div",
                  { className: "col-12 space-between" },
                  ...
                  React.createElement("input", { className: "col-7 input-text", type: "text", name: "gender" })
                ),
                React.createElement(
                  "div",
                  { className: "col-12 middle space-between" },
                  React.createElement(
                    "button",
                    { className: "btn-lg btn-primary", onClick: this.saveNewUser.bind(this) },
                    "Save"
                  ),
                  React.createElement(
                    "button",
                    { className: "btn-lg btn-default", onClick: this.cancel.bind(this) },
                    "Cancel"
                  )
                )
              );
              ...
              return React.createElement(
                "div",
                { className: "col-12 column userList-top" },
                React.createElement(
                  "button",
                  { className: "btn-lg btn-block btn-primary add-button", onClick: this.addNewUser.bind(this) },
                  "Add New User"
                ),
                React.createElement("br", null),
                React.createElement("input", { className: "search-user input-text", type: "text", placeholder: "Search User By Name", onChange: this.searchUser.bind(this) })
              );
            }
          }
        }, {
          key: "render",
          value: function render() {
            var usersAsNodes = this.props.users.map(function (user, index) {
              return React.createElement(User, { key: user.id, order: index, userData: user });
            });
            var view = this._render();
            return React.createElement(
              "div",
              { className: "col-12 userList" },
              view,
              usersAsNodes
            );
          }
...
System.register("app/scripts/flux/Subscriber.js", ["npm:babel-runtime@5.8.34/helpers/create-class", "npm:babel-runtime@5.8.34/helpers/class-call-check"], function (_export) {
  var _createClass, _classCallCheck, Store, instance, Subscriber;
    ...
    execute: function () {
      ...
      Store = (function () {
        ...
        _createClass(Store, [{
          ...
          key: "publish",
          value: function publish(eventName, eventDataObj) {
            var _this = this;
            ...
            eventHandlers.forEach(function (eHandler) {
              console.log("Publishing event", eventName, "to", _this.name, "with data", eventDataObj);
      ...
      Subscriber = (function () {
        ...
        _createClass(Subscriber, [{
          ...
          key: "createStore",
          value: function createStore(storeName) {
...
System.register('app/main.js', ['npm:babel-runtime@5.8.34/helpers/get', 'npm:babel-runtime@5.8.34/helpers/inherits', 'npm:babel-runtime@5.8.34/helpers/create-class', 'npm:babel-runtime@5.8.34/helpers/class-call-check', 'npm:react@0.14.3', 'npm:react-dom@0.14.3', 'app/scripts/components/userList.js', 'app/scripts/flux/Subscriber.js'], function (_export) {
  var _get, _inherits, _createClass, _classCallCheck, React, ReactDOM, UserList, Subscriber;
  ...
  return {
    ...
    }, function (_appScriptsComponentsUserListJs) {
      UserList = _appScriptsComponentsUserListJs['default'];
    }, function (_appScriptsFluxSubscriberJs) {
      Subscriber = _appScriptsFluxSubscriberJs['default'];
    }],
    execute: function () {
      ...
      (function () {
        var App = (function (_React$Component) {
          ...
          function App() {
            ...
            this.users = [{ id: 1, firstname: "Taner", surname: "Gokalp", country: "Turkey", age: 25, gender: "Male" }, { id: 2, firstname: "John", surname: "Doe", country: "United States", age: 20, gender: "Male" }, { id: 3, firstname: "François", surname: "Bregerie", country: "France", age: 35, gender: "Male" }, { id: 4, firstname: "Francesco", surname: "Potelli", country: "Italy", age: 40, gender: "Male" }, { id: 5, firstname: "Fabian", surname: "Zilinski", country: "Germany", age: 25, gender: "Male" }];
          ...
          _createClass(App, [{
            ...
            value: function componentDidMount() {
              ...
              this.store.subscribe("filter", function (filterStr) {
              ...
              this.store.subscribe("add", function (newUserData) {
                _this.users = _this.users.concat([newUserData]);
                console.log("Re-rendering after add with data", _this.users);
              ...
              this.store.subscribe("delete", function (userIndex) {
                _this.users.splice(userIndex, 1);
                console.log("Re-rendering after delete with data", _this.users);
              ...
              this.store.subscribe("update", function (updatedUser) {
                _this.users[updatedUser.order] = updatedUser.data;
                console.log("Re-rendering after update with data", _this.users);
